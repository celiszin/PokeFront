...
const TodosTipos = [
    ...
    { nome: "Eletrico", cor: "rgba(255, 204, 51, 0.75)" },
    ...
    { nome: "Psiquico", cor: "rgba(255, 85, 153, 0.75)" },
...
function carousel(sprites) {
  ...
  <div class= "carousel-inner">
    <div class="carousel-item active">
      <img src= "${sprites.other["official.artwork"].from_default}" class="d-block w-100 alt="Padrão">
    </div>
    <div class= "carousel-item">
      <img src= "${sprites.other["official.artwork"].from_shiny}" class="d-block w-100 alt="Shiny">
    </div>
